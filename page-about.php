                ...
                <div class="mdl-cell mdl-cell--8-col">
                  ...
                  <div class="mdl-grid">
                    <section class="team-member mdl-cell mdl-cell--6-col">
                      <div class="img">
                        <img class="circle" src="<?php echo get_template_directory_uri(); ?>/img/justin.png" alt="">
                      </div>
                      <div class="name">
                        Justin LoFranco
                      </div>
                    ...
                    <section class="team-member mdl-cell mdl-cell--6-col">
                      <div class="img">
                        <img class="circle" src="<?php echo get_template_directory_uri(); ?>/img/eric.png" alt="">
                      </div>
                      <div class="name">
                        Eric Sherred
                      </div>
                    ...
                    <section class="team-member mdl-cell mdl-cell--6-col">
                      <div class="img">
                        <img class="circle" src="<?php echo get_template_directory_uri(); ?>/img/jesse-k.png" alt="">
                      </div>
                      <div class="name">
                        Jesse Krim
                      </div>
                    ...
                    <section class="team-member mdl-cell mdl-cell--6-col">
                      <div class="img">
                        <img class="circle" src="<?php echo get_template_directory_uri(); ?>/img/jesse-f.png" alt="">
                      </div>
                      <div class="name">
                        Jesse Friedl
                      </div>
